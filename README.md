...
This project is an end-to-end Data Analysis project based on 1,00,000 Ola ride booking records. The objective was to clean, analyze, and visualize booking data to generate meaningful business insights.
...
Measured booking revenue across payment methods.
